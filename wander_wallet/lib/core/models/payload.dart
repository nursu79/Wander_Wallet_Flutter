...
class ExpensePayload {
  ...
  ExpensePayload({ required this.expense });

  factory ExpensePayload.fromJson(Map<String, dynamic> json) => _$ExpensePayloadFromJson(json);
  Map<String, dynamic> toJson() => _$ExpensePayloadToJson(this);
}
